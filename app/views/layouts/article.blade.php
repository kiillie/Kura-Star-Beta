...
<head>
        ...
        <title>{{$article->CURATION_TITLE}}</title>
        <meta name="description" content="{{$article->CURATION_DESCRIPTION}}">
				...
				<div class="head1">
					<div class="defaultWidth center headwrap">
						...
						@if(Hybrid_Auth::isConnectedWith('Facebook'))
							<a href="{{URL::route('auth.logout')}}"><img src="/assets/images/new/icon_login.png" />ログアウト</a>
							<a href="{{URL::route('user.profile', $hybrid->CURATER_ID)}}"> <img src="{{$hybrid->CURATER_IMAGE}}" />{{strtoupper($hybrid->CURATER)}}</a>
							<a href="{{URL::route('article.insert')}}"><img src="/assets/images/new/icon_write.png" />POST</a>
						@else
							@if(Auth::check())
								<a href="{{URL::route('logout')}}"><img src="/assets/images/new/icon_login.png" />ログアウト</a>
								...
								<a href="{{URL::route('article.insert')}}"><img src="/assets/images/new/icon_write.png" />POST</a>
							@else
								<a href="{{URL::route('login')}}"><img src="/assets/images/new/icon_login.png" />ログイン</a>
								<a href="{{URL::route('registration')}}"><img src="/assets/images/new/icon_signup.png" />登録</a>
				...
				<div class="head2">
					<div class="defaultWidth center menuwrap">
						<ul class="menu">
							...
							<li><a href="{{URL::route('article.bycategory', 4)}}" class="menucat"><i class="fa fa-leanpub fa-2x"></i>&nbsp; 学び</a></li>
							<li><a href="{{URL::route('article.bycategory', 5)}}" class="menucat"><i class="fa fa-usd fa-2x"></i>&nbsp; ビジネス</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="defaultWidth center clear-auto block-footer2-wrap">
						...
						<div class="footcategory">
							...
							<div>
								<h4>Menu</h4>
								<ul>
									<li><a href="{{URL::route('article.bycategory', 1)}}"><i class="fa fa-cutlery"></i>&nbsp;グルメ</a></li>
									<li><a href="{{URL::route('article.bycategory', 2)}}"><i class="fa fa-music"></i>&nbsp;観光</a></li>
									<li><a href="{{URL::route('article.bycategory', 3)}}"><i class="fa fa-briefcase"></i>&nbsp;生活</a></li>
									<li><a href="{{URL::route('article.bycategory', 4)}}"><i class="fa fa-leanpub"></i>&nbsp;学び</a></li>
									<li><a href="{{URL::route('article.bycategory', 5)}}"><i class="fa fa-usd"></i>&nbsp;ビジネス</a></li>
								</ul>
							</div>
						</div>
					</div>
